...
local _G_AL_lbl, _G_AL_swBg, _G_AL_swCircle = makeMiniRow("AUTO LEFT",  46)
local _G_AR_lbl, _G_AR_swBg, _G_AR_swCircle = makeMiniRow("AUTO RIGHT", 100)
